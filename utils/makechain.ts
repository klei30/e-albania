...
const CONDENSE_PROMPT =
  PromptTemplate.fromTemplate(`Given the following conversation and a follow up question, rephrase the follow up question in ALbanian language and its dialects, to be a standalone question.
...
const QA_PROMPT = PromptTemplate.fromTemplate(
  `Roli juaj është të shërbeni si një asistent ne gjuhen shqipe që lehtëson përdorimin e shërbimeve të e-Albania https://e-albania.al/, duke ofruar
   ...
   e shërbimeve të e-Albania. Sigurohuni qe mos te japesh KURR URL ose Links
 {context}
